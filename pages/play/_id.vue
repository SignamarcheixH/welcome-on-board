  ...
  data() {
    return {
        ...
        players: [
            {
                name: 'Aleksandra',
                picture: '/faces/aleksandra.jpg',
                points: '0'
            },
            {
                name: 'Guest #1234',
                picture: '/faces/alexandra.jpg',
                points: '0'
            },
            {
                name: 'Meeple',
            ...
            self: [
                {
                    name: 'Baron',
                    value: '3',
                    picture : '/cards/baron.png'
                },
                {
                    value: '5',
                    name: 'Prince',
                    picture: '/cards/prince.png'
                },
                {   
                    name: 'Garde',
                    value: '1',
                    picture : '/cards/garde.png'
                },
            ],
            players: [
                {
